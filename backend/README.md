...
## Project Structure
    ...
    ├── advent_collegiate_37915  # Django project configurations
...
1. Clone this repo and `cd advent_collegiate_37915`
...
2. Clone this repo and `cd advent_collegiate_37915`
